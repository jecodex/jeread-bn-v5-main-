...
import { Settings, User, Bell, Moon, Globe, Lock, Shield, Mail, CreditCard, UserX, Download, Trash2, BookOpen, Bookmark, Share2, Type, Search, ChevronRight, Sun } from 'lucide-react';
          ...
          <div className="flex flex-col md:flex-row gap-6">
            ...
            <div className="w-full md:w-64">
              <div className="bg-white dark:bg-gray-800 rounded-lg shadow overflow-hidden">
                <div className="bg-teal-500 dark:bg-teal-600 p-4">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-lg shadow mt-4 p-4">
                ...
                <button className="w-full px-3 py-2 bg-gray-100 dark:bg-gray-700 text-teal-600 dark:text-teal-400 text-sm rounded-md hover:bg-gray-200 dark:hover:bg-gray-600 transition duration-200 flex items-center justify-center">
